...
LESS_SPAMMY = os.environ.get("MAX_SPAM", None)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
...
USER_BOT_NO_WARN = ("[┈╭━━╮╭━━╮┈┈┈┈┈ \n┈┃╭╮┗┻━━┻━╮┈┈┈ \n┈┃╰┓╭━╮╭━╮┃┈┈┈ \n┈╰━┓┃▇┃┃▇┃┃┈┈┈ \n┈┈┈┃╱▔▔▔▔▔▔▔▇┈ \n┈┈┈┃▏┏┳┳┳┳┳━┛┈ \n┈┈┈┃╲╰┻┻┻┻┻┓┈┈](tg://user?id=1037944593)\n\n"
                    "`Hello, this is Ultra Level Telegram Security Service of Andencento for peru users only.You have found your way here to my master,`"
