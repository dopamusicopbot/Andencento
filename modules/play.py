...
@Client.on_message(filters.command(['play', 'play@Andencentovcbot']) & ~filters.edited & ~filters.bot)
@chat_allowed
@admin_mode_check
                ...
                if filename is None:
                    ...
                    if Config.get('PLAYBACK_FOOTER') not in ['', None]:
                        footer = f"{Config.get('PLAYBACK_FOOTER')}".replace(
                            '\\n', '\n')
                    footer_val = (
                        '\n'+footer) if footer is not None else '\nFor any issues contact @Andencentosupport'
                    ...
                    if response is not True:
                        ...
                        try:
                            ...
                            title_change = EditGroupCallTitle(call=chat.full_chat.call,
                                                              title="Song Player | By Team Andencento")
