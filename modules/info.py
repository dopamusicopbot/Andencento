...
@Client.on_message(filters.command(['info', 'info@Andencentovcbot']) & ~filters.edited & ~filters.bot)
@database_check
@chat_allowed
@admin_check
...
@Client.on_message(filters.command(['start', 'start@Andencentovcbot', 'help', 'help@Andencentovcbot']) & ~filters.edited)
