...
try:
    print("Make sure you have API Client ID and Hash , If not goto my.telegram.org and generate it.\n\n")
    ...
    with client:
        ...
        client.send_message(
            "me", f"Your session String :\n\n`{session}`\n\nBy @Andencentovcbot | [Team Andencento Product](https://t.me/Andencento)")
